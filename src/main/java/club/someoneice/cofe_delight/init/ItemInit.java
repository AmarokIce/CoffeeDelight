...
public class ItemInit {
    ...
    // Cap
    public static final RegistryObject<Item> CAP = ITEMS.register("coffee_cap", () -> new BlockItem(BlockInit.COFFEE_CAP.get(), new Item.Properties().tab(CoffeeDelight.COFFEE)));
    public static final RegistryObject<Item> MAG = ITEMS.register("coffee_mag", () -> new BlockItem(BlockInit.COFFEE_MAG.get(), new Item.Properties().tab(CoffeeDelight.COFFEE)));
